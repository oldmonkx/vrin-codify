...
export default function Hero({ onDownloadBrochure }: HeroProps) {
  ...
  const mobileHeroBackground = '/3d-renders/3646_Vrindavan_Namishree__Kondapur_Image_11.jpg';
    ...
    <section id="overview" className="relative overflow-hidden border-b border-brand-gold/10">
      ...
      <div className="absolute inset-0">
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 hidden h-full w-full scale-[1.03] object-contain object-center lg:block"
        />
      ...
      <div className="section-shell relative grid min-h-[calc(100dvh-4rem)] items-center gap-8 py-8 md:py-10 lg:grid-cols-[minmax(0,1fr)_minmax(340px,430px)] lg:gap-12">
        ...
        >
          {/* Vrindavan Logo */}
          <img src={heroContent.logo} alt="Vrindavan" className="h-14 w-auto md:h-16 lg:h-[4.5rem]" />

          {/* Tagline & Headline */}
          <div className="mt-6 lg:mt-7">
            <span className="eyebrow">{heroContent.eyebrow}</span>
            <h1 className="mt-5 font-light leading-[0.94] tracking-normal text-brand-ink">
